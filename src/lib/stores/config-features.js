export const config = {
	mapTitle: 'map-meps-country', // The title of the map, if more than one word, separate by dash, e.g. "income-europe"
	vercelURL: 'https://map-meps-country.vercel.app/', // The url provided when deploying the map on Vercel
